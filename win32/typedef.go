...
func (hr HRESULT) String() string {
	...
	case DRAGDROP_S_DROP:
		return "DRAGDROP_S_DROP" //        = 0x00040100
	case DRAGDROP_S_CANCEL:
		return "DRAGDROP_S_CANCEL" //  0x00040101
	...
	case DV_E_DVTARGETDEVICE:
		return "DV_E_DVTARGETDEVICE" // 0x80040065
	case DV_E_STGMEDIUM:
		return "DV_E_STGMEDIUM" //  0x80040066
	case DV_E_STATDATA:
		return "DV_E_STATDATA" //  0x80040067
	case DV_E_LINDEX:
		return "DV_E_LINDEX" //  0x80040068
	case DV_E_TYMED:
		return "DV_E_TYMED" // 0x80040069
	case DV_E_CLIPFORMAT:
		return "DV_E_CLIPFORMAT" //  0x8004006A
	case DV_E_DVASPECT:
		return "DV_E_DVASPECT" //  0x8004006B
	case DV_E_DVTARGETDEVICE_SIZE:
		return "DV_E_DVTARGETDEVICE_SIZE" //  0x8004006C
	case DV_E_NOIVIEWOBJECT:
		return "DV_E_NOIVIEWOBJECT" //  0x8004006D
	case DRAGDROP_E_NOTREGISTERED:
		return "DRAGDROP_E_NOTREGISTERED" //  0x80040100
	case DRAGDROP_E_ALREADYREGISTERED:
		return "DRAGDROP_E_ALREADYREGISTERED" //  0x80040101
	case DRAGDROP_E_INVALIDHWND:
		return "DRAGDROP_E_INVALIDHWND" //  0x80040102
	default:
		return fmt.Sprintf("HRESULT(0x%08X)", uintptr(hr))
	}
}
