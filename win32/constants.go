...
const (
	CF_TEXT            CLIPFORMAT = 1
	CF_BITMAP          CLIPFORMAT = 2
	CF_METAFILEPICT    CLIPFORMAT = 3
	CF_SYLK            CLIPFORMAT = 4
	CF_DIF             CLIPFORMAT = 5
	CF_TIFF            CLIPFORMAT = 6
	CF_OEMTEXT         CLIPFORMAT = 7
	CF_DIB             CLIPFORMAT = 8
	CF_PALETTE         CLIPFORMAT = 9
	CF_PENDATA         CLIPFORMAT = 10
	CF_RIFF            CLIPFORMAT = 11
	CF_WAVE            CLIPFORMAT = 12
	CF_UNICODETEXT     CLIPFORMAT = 13
	CF_ENHMETAFILE     CLIPFORMAT = 14
	CF_HDROP           CLIPFORMAT = 15
	CF_LOCALE          CLIPFORMAT = 16
	CF_DIBV5           CLIPFORMAT = 17
	CF_MAX             CLIPFORMAT = 18
	CF_OWNERDISPLAY    CLIPFORMAT = 0x0080
	CF_DSPTEXT         CLIPFORMAT = 0x0081
	CF_DSPBITMAP       CLIPFORMAT = 0x0082
	CF_DSPMETAFILEPICT CLIPFORMAT = 0x0083
	CF_DSPENHMETAFILE  CLIPFORMAT = 0x008E
	CF_PRIVATEFIRST    CLIPFORMAT = 0x0200
	CF_PRIVATELAST     CLIPFORMAT = 0x02FF
	CF_GDIOBJFIRST     CLIPFORMAT = 0x0300
	CF_GDIOBJLAST      CLIPFORMAT = 0x03FF
)

func (cf CLIPFORMAT) String() string {
	switch cf {
	case CF_TEXT:
		return "CF_TEXT" // = 1
	case CF_BITMAP:
	...
	case CF_OWNERDISPLAY:
		return "CF_OWNERDISPLAY" // = 0x0080
	case CF_DSPTEXT:
		return "CF_DSPTEXT" // = 0x0081
	case CF_DSPBITMAP:
		return "CF_DSPBITMAP" // = 0x0082
	case CF_DSPMETAFILEPICT:
		return "CF_DSPMETAFILEPICT" // = 0x0083
	case CF_DSPENHMETAFILE:
		return "CF_DSPENHMETAFILE" // = 0x008E
	case CF_PRIVATEFIRST:
		return "CF_PRIVATEFIRST" // = 0x0200
	case CF_PRIVATELAST:
		return "CF_PRIVATELAST" // = 0x02FF
	case CF_GDIOBJFIRST:
		return "CF_GDIOBJFIRST" // = 0x0300
	case CF_GDIOBJLAST:
		return "CF_GDIOBJLAST" // = 0x03FF
	default:
		return fmt.Sprintf("CLIPFORMAT(%d)", uint16(cf))
	}
}
...
const (
	...
	CSIDL_DESKTOPDIRECTORY = 0x0010 // user desktop
	CSIDL_FONTS            = 0x0014 // fonts
	CSIDL_APPDATA          = 0x001a // user app data
	CSIDL_LOCAL_APPDATA    = 0x001c // non roaming app data
)
