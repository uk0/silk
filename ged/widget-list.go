...
var categoryDefs = []struct {
	...
	{
		name:  "输入控件 (Input)",
		names: []string{"gui.Button", "gui.Edit", "gui.TextArea", "gui.CheckBox", "gui.RadioButton", "gui.ComboBox", "gui.SpinBox", "gui.Slider", "gui.ToggleSwitch", "gui.SearchBox", "gui.NumberInput", "gui.DatePicker", "gui.Calendar", "gui.TimePicker", "gui.ColorPicker", "gui.Rating", "gui.DropdownButton", "gui.SwitchGroup", "gui.PathEdit"},
	},
	{
		name:  "显示控件 (Display)",
	...
	{
		name:  "组态 (SCADA)",
		names: []string{"gui.Tank", "gui.Indicator", "gui.DigitalDisplay", "gui.Valve", "gui.Pipe", "gui.Pump", "gui.Thermometer", "gui.ValueBar", "gui.DeviceComponent", "gui.AlarmPanel", "gui.RecipePanel", "gui.ReportView", "gui.EventLogPanel", "gui.TrendPanel", "gui.StatsPanel", "gui.CalcPanel"},
	},
	{
		name:  "对话框/窗口 (Window)",
